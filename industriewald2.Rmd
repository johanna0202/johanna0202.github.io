...
```{r, echo = F, warning = F, fig.cap = '*Links: Laubbäume und Sträucher Rechts: Baumkronen (Quelle: Eigene Aufnahme 2021)*', fig.width = 4, out.width = "80%"}
...
```{r, echo = F, warning = F, fig.cap = '*Herumliegende Baumstämme und Gehölz (Quelle: Eigene Aufnahme 2021)*', fig.width = 4, out.width = "100%"}
...
```{r, echo = F, warning = F, fig.cap = '*Links: schmaler Trampelpfad Mitte & Rechts: Offener Wald ohne Wegeführung (Quelle: Eigene Aufnahme 2021)*', fig.width = 4, out.width = "80%"}
...
```{r, echo = F, warning = F, fig.cap = '*Links: Vereinsheim Hundesport Rechts: Dazugehöriger Park (Quelle: Eigene Aufnahme 2021)*', fig.width = 4, out.width = "80%"}
...
```{r, echo = F, warning = F, fig.cap = '*Links: Umzäunung Rechts: Kaputter Zaun mit offenem Feld und Straße dahinter (Quelle: Eigene Aufnahme 2021)*', fig.width = 4, out.width = "80%"}
knitr::include_graphics('ludwig8.PNG')
``` 
       

```{r, echo = F, warning = F, fig.cap = '*Wohnbebauung angrenzend an den Wald (Quelle: Eigene Aufnahme 2021)*', fig.width = 4, out.width = "80%"}
